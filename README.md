...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,6,11,20&height=200&section=header&text=Shrijan%20Tiwari&fontSize=70&fontColor=fff&animation=twinkling&fontAlignY=35&desc=AI%20%7C%20ML%20%7C%20Full%20Stack%20Dev&descSize=20&descAlignY=55" width="100%"/>

<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&size=32&duration=2500&pause=800&color=00F5FF&center=true&vCenter=true&width=700&lines=AI%20%26%20ML%20Engineer;Python%20%7C%20TensorFlow%20%7C%20PyTorch;Building%20Intelligent%20Systems;Transforming%20Ideas%20into%20Reality" alt="Dynamic Typing" />
</p>
...
**Shrijan Tiwari** — Aspiring AI/ML Engineer & Full Stack Developer based in India 🇮🇳
...
- ☁️ Cloud infrastructure (AWS/GCP) & MLOps pipelines
- 🧠 Deep Learning, NLP, Computer Vision & GenAI
- 📊 End-to-end ML lifecycle management
- 🚀 Full Stack Web Development (MERN, Next.js)

**Current Focus 2026:**
- 🔥 Building LLM-powered applications & AI Agents
- 🌐 Implementing CI/CD for ML models with Docker & Kubernetes
...
shrijan_tiwari = {
    ...
    "ml_stack": ["TensorFlow", "PyTorch", "Scikit-learn", "Hugging Face"],
    "web_stack": ["React", "Next.js", "Node.js", "FastAPI", "Flask"],
    "cloud": ["AWS", "GCP", "Docker", "Kubernetes", "Vercel"],
    "tools": ["MLflow", "Weights & Biases", "Git", "Jupyter", "Figma"],
    "interests": ["GenAI", "Computer Vision", "NLP", "MLOps"],
...
**LLM-powered conversational AI with retrieval**

`Python` `LangChain` `Hugging Face` `FastAPI` `Docker`

**Key Achievements:**
- 🧠 RAG pipeline with 90%+ answer relevance
- 🔗 Multi-source document retrieval (PDF, Web, DB)
- ⚡ Sub-2s response time with caching
- 🌐 REST API serving 500+ daily queries

**Impact:** Automating customer support with AI
...
`Python` `YOLOv8` `OpenCV` `TensorFlow` `Flask`

**Key Achievements:**
- 🎯 95%+ mAP on COCO dataset
- 📹 Real-time video stream processing (30 FPS)
- 📱 Deployed on edge devices (Raspberry Pi)
- 🔄 Auto-training pipeline with active learning

**Innovation:** Smart surveillance & automation
...
`Python` `MLflow` `Docker` `Kubernetes` `AWS`

**Key Achievements:**
- 🔄 Automated CI/CD for ML models
- 📈 Real-time model monitoring & drift detection
- 🗄️ Feature store with versioning
- 🚀 40% faster deployment cycles

**Highlight:** Production-grade MLOps architecture
...
**Modern analytics dashboard with AI insights**
...
<p align="center">
  <img src="https://user-images.githubusercontent.com/74038190/212284087-bbe7e430-757e-4901-90bf-4cd2ce3e1852.gif" width="100" alt="">
</p>
...
<p align="center">
  <img src="https://user-images.githubusercontent.com/74038190/216122041-518ac897-8d92-4c6b-9b3f-ca01dcaf38ee.png" width="50" alt="Rocket icon" />
</p>
...
**Actively seeking:** AI Engineer | ML Engineer | Full Stack Developer | GenAI Specialist
